        ...
        {vendor.stripe_account_id ? (
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-1.5 text-yellow-700">
              ...
              <span className="text-sm font-medium">Not connected — bookings disabled</span>
            </div>
            <p className="text-sm text-zinc-600">
              You can publish without Stripe. Your listing goes live and stays editable, but students
              can&apos;t book or pay through CarryClass until you{" "}
              <Link href="/onboard/step/5" className="underline hover:text-zinc-900">
                connect Stripe
              </Link>
              .
            </p>
